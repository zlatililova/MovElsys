...
class UserAccount {
    ...
    fun setPlaceholders(
        ...
        confirmationPasswordError = confirmPass
        nameError = name
        profilePictureError = profilePic
    }
