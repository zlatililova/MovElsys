...
class ProfileUpdateUseCase(
    ...
    fun updateUserName(name: String, onUpdate: OnUpdate) =
        profileUpdate.updateUserName(name, onUpdate)

    fun updateUserProfilePic(url: String, onUpdate: OnUpdate) =
        profileUpdate.updateUserProfilePicture(url, onUpdate)

    fun updateUserEmail(email: String, onUpdate: OnUpdate) =
        profileUpdate.updateUserEmail(email, onUpdate)
